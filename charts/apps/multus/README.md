...
![Version: 5.0.7](https://img.shields.io/badge/Version-5.0.7-informational?style=flat-square) ![AppVersion: v4.0.2](https://img.shields.io/badge/AppVersion-v4.0.2-informational?style=flat-square)
...
| cni.paths.bin | string | `"/var/lib/rancher/k3s/data/cni"` | CNI plugin binaries folder for k3s. Change to `/opt/cni/bin` for non k3s |
